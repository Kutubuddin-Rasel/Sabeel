...
object DhikrCatalog {
    ...
    private val afterPrayer = listOf(
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Subhāna Allāh", bn = "সুবহানাল্লাহ"),
        ...
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Al-ḥamdu lillāh", bn = "আলহামদুলিল্লাহ"),
            meaning = DhikrMeaning(
        ...
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Allāhu akbar", bn = "আল্লাহু আকবার"),
            meaning = DhikrMeaning(
        ...
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "SubhanAllah · Alhamdulillah · Allahu Akbar", bn = "সুবহানাল্লাহ · আলহামদুলিল্লাহ · আল্লাহু আকবার"),
            meaning = DhikrMeaning(
        ...
        DhikrItem(
            ...
            displayName = LocalizedText(en = "Tasbih after Salah", bn = "নামাজের পরে তাসবিহ"),
            transliteration = LocalizedText(en = "SubhanAllah · Alhamdulillah · Allahu Akbar · Lā ilāha illallāhu waḥdahu lā sharīka lahu, lahul-mulku wa lahul-ḥamdu, wa huwa 'alā kulli shay'in qadīr", bn = "সুবহানাল্লাহ · আলহামদুলিল্লাহ · আল্লাহু আকবার · লা ইলাহা ইল্লাল্লাহু ওয়াহদাহু লা শারীকা লাহু, লাহুল মুলকু ওয়া লাহুল হামদু, ওয়া হুয়া আলা কুল্লি শাইয়িন ক্বাদীর"),
            meaning = DhikrMeaning(
    ...
    private val daily = listOf(
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Astaghfiru Allāh", bn = "আস্তাগফিরুল্লাহ"),
            meaning = DhikrMeaning(
        ...
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Subhāna Allāhi wa biḥamdih", bn = "সুবহানাল্লাহি ওয়া বিহামদিহি"),
            meaning = DhikrMeaning(
        ...
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Subhāna Allāhi l-'aẓīm", bn = "সুবহানাল্লাহিল আযীম"),
            meaning = DhikrMeaning(
    ...
    private val morning = listOf(
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Ḥasbiya Allāhu lā ilāha illā huwa 'alayhi tawakkaltu wa huwa rabbul 'arshil 'aẓīm", bn = "হাসবিয়াল্লাহু লা ইলাহা ইল্লা হুয়া আলাইহি তাওয়াক্কালতু ওয়া হুয়া রাব্বুল আরশিল আযীম"),
            meaning = DhikrMeaning(
        ...
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "A'ūdhu bikalimatillāhi t-tāmmāti min sharri mā khalaqa", bn = "আউযু বিকালিমাতিল্লাহিত তাম্মা-তি মিন শাররি মা খালাক"),
            meaning = DhikrMeaning(
        ...
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Lā ilāha illallāhu waḥdahu lā sharīka lahu, lahul-mulku wa lahul-ḥamdu, wa huwa 'alā kulli shay'in qadīr", bn = "লা ইলাহা ইল্লাল্লাহু ওয়াহদাহু লা শারীকা লাহু, লাহুল মুলকু ওয়া লাহুল হামদু, ওয়া হুয়া আলা কুল্লি শাইয়িন ক্বাদীর"),
            meaning = DhikrMeaning(
    ...
    private val evening = listOf(
        ...
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Astaghfiru Allāha wa atūbu ilayh", bn = "আস্তাগফিরুল্লাহ ওয়া আতুবু ইলাইহ"),
            meaning = DhikrMeaning(
    ...
    private val salawat = listOf(
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Allāhumma ṣalli 'alā Muḥammad", bn = "আল্লাহুম্মা সাল্লি আলা মুহাম্মাদ"),
            meaning = DhikrMeaning(
        ...
        DhikrItem(
            ...
            displayName = LocalizedText(en = "Salawat", bn = "দরূদ"),
            transliteration = LocalizedText(en = "Allāhumma ṣalli wa sallim 'alā nabiyyinā Muḥammad", bn = "আল্লাহুম্মা সাল্লি ওয়া সাল্লিম আলা নাবিয়্যিনা মুহাম্মাদ"),
            meaning = DhikrMeaning(
        ...
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Allāhumma ṣalli 'alā Muḥammadin wa 'alā āli Muḥammad, kamā ṣallayta 'alā Ibrāhīma wa 'alā āli Ibrāhīm, innaka ḥamīdun majīd. Allāhumma bārik 'alā Muḥammadin wa 'alā āli Muḥammad, kamā bārakta 'alā Ibrāhīma wa 'alā āli Ibrāhīm, innaka ḥamīdun majīd.", bn = "আল্লাহুম্মা সাল্লি আলা মুহাম্মাদিন ওয়া আলা আলি মুহাম্মাদ, কামা সাল্লাইতা আলা ইবরাহীমা ওয়া আলা আলি ইবরাহীম, ইন্নাকা হামীদুন মাজীদ। আল্লাহুম্মা বারিক আলা মুহাম্মাদিন ওয়া আলা আলি মুহাম্মাদ, কামা বারাকতা আলা ইবরাহীমা ওয়া আলা আলি ইবরাহীম, ইন্নাকা হামীদুন মাজীদ।"),
            meaning = DhikrMeaning(
    ...
    private val istighfar = listOf(
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Astaghfiru Allāha l-'aẓīma lladhī lā ilāha illā huwa", bn = "আস্তাগফিরুল্লা-হাল আযী-মাল্লাযী লা ইলা-হা ইল্লা হুওয়া"),
            meaning = DhikrMeaning(
        ...
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Allāhumma anta rabbī lā ilāha illā anta, khalaqtanī wa anā 'abduka, wa anā 'alā 'ahdika wa wa'dika māstaṭa'tu, a'ūdhu bika min sharri mā ṣana'tu, abū'u laka bini'matika 'alayya, wa abū'u laka bidhanbī faghfir lī fa'innahu lā yaghfirudh-dhunūba illā anta.", bn = "আল্লাহুম্মা আন্তা রাব্বী লা ইলাহা ইল্লা আন্তা, খালাকতানী ওয়া আনা আবদুকা, ওয়া আনা আলা আহদিকা ওয়া ওয়া'দিকা মাস্তাত্বা'তু, আউযু বিকা মিন শাররি মা সানা'তু, আবূ'উ লাকা বিনি'মাতিকা আলাইয়্যা, ওয়া আবূ'উ লাকা বিযাম্বী ফাগফির লী ফা ইন্নাহু লা ইয়াগফিরুয যুনূবা ইল্লা আন্তা।"),
            meaning = DhikrMeaning(
    ...
    private val tahlil = listOf(
        ...
        DhikrItem(
            ...
            displayName = LocalizedText(en = "Tahlil", bn = "তাহলীল"),
            transliteration = LocalizedText(en = "Lā ilāha illā Allāh", bn = "লা ইলাহা ইল্লাল্লাহ"),
            meaning = DhikrMeaning(
    ...
    val asmaAll = listOf(
        DhikrItem(
            ...
            transliteration = LocalizedText(en = "Asmā’ Allāh Al-Ḥusnā", bn = "আসমাউল হুসনা"),
            meaning = DhikrMeaning(
    ...
    private val stepSubhan = DhikrStep("سُبْحَانَ اللَّهِ", LocalizedText(en = "SubhanAllah", bn = "সুবহানাল্লাহ"), LocalizedText(en = "Subhāna Allāh", bn = "সুবহানাল্লাহ"), DhikrMeaning("Allah is free from all imperfections", "আল্লাহ সকল ত্রুটি ও অসম্পূর্ণতা থেকে মুক্ত"), 33)
    private val stepHamd = DhikrStep("الْحَمْدُ لِلَّهِ", LocalizedText(en = "Alhamdulillah", bn = "আলহামদুলিল্লাহ"), LocalizedText(en = "Al-ḥamdu lillāh", bn = "আলহামদুলিল্লাহ"), DhikrMeaning("All absolute praise and gratitude belong solely to Allah", "সমস্ত নিরঙ্কুশ প্রশংসা এবং কৃতজ্ঞতা একমাত্র আল্লাহর"), 33)
    private val stepAkbar34 = DhikrStep("اللَّهُ أَكْبَرُ", LocalizedText(en = "Allahu Akbar", bn = "আল্লাহু আকবার"), LocalizedText(en = "Allāhu akbar", bn = "আল্লাহু আকবার"), DhikrMeaning("Allah is infinitely greater than anything else we can comprehend", "আল্লাহ আমাদের উপলব্ধির চেয়েও অসীম মহান"), 34)
    private val stepAkbar33 = stepAkbar34.copy(target = 33)
    private val stepTahlil = DhikrStep("لَا إِلَٰهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ، وَهُوَ عَلَىٰ كُلِّ شَيْءٍ قَدِيرٌ", LocalizedText(en = "Tahlil", bn = "তাহলীল"), LocalizedText(en = "Lā ilāha illallāhu waḥdahu lā sharīka lahu...", bn = "লা ইলাহা ইল্লাল্লাহু ওয়াহদাহু লা শারীকা লাহু..."), DhikrMeaning("There is no true deity but Allah alone, Who has no partner; His is the dominion and His is the praise, and He is Able to do all things", "আল্লাহ ছাড়া কোনো উপাস্য নেই, তিনি এক, তাঁর কোনো শরীক নেই; রাজত্ব তাঁরই, এবং সমস্ত প্রশংসাও তাঁর; এবং তিনি সবকিছুর ওপর ক্ষমতাবান"), 1)

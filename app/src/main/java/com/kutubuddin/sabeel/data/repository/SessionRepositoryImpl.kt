...
import com.kutubuddin.sabeel.data.local.db.dao.AggregatedSessionRow
...
class SessionRepositoryImpl @Inject constructor(
    ...
    override fun getAggregatedSessionsForDate(dateKey: String): Flow<List<com.kutubuddin.sabeel.data.local.db.dao.AggregatedSessionRow>> {

...
interface NotificationService {
     ...
     */
    fun showStreakProtectorNotification(streakDays: Int, language: String)
     ...
     */
    fun showDailyGoalFinisherNotification(dhikrName: String, remainingTarget: Int, dhikrKey: String, language: String)

    /**
     * Shows a gentle nudge to a new user who has an incomplete daily goal.
     * Tapping it opens the Home screen.
     */
    fun showGentleNudgeNotification(language: String)
}

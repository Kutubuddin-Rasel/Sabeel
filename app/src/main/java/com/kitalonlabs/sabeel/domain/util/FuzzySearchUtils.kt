package com.kitalonlabs.sabeel.domain.util
...
object FuzzySearchUtils {
     ...
     * (both Latin marks and Arabic Tashkeel) and Bangla phonetic marker
     * characters (':' for long-ā, ''' for ʿayn/hamza) so that plain queries
     * like সুবহানাল্লাহ still match phonetically-marked forms like সুবহ'া:নাল্লা:হ.
     */
    fun normalize(text: String): String {
        val temp = java.text.Normalizer.normalize(text, java.text.Normalizer.Form.NFD)
        // Remove: combining diacritical marks (Latin), Arabic Tashkeel (\u064B-\u065F),
        // and Bangla phonetic markers (':' long-vowel, ''' ʿayn/hamza).

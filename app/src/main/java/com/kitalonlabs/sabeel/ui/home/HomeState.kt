...
import com.kitalonlabs.sabeel.domain.model.WirdGoalHintState
...
/**
 * UI-safe projection of [com.kitalonlabs.sabeel.data.local.db.entity.DhikrSessionEntity].
 *
 * SRP/DIP: the Room entity must never cross into the Composable layer, and
 * resolving a display name from [com.kitalonlabs.sabeel.domain.model.DhikrCatalog]

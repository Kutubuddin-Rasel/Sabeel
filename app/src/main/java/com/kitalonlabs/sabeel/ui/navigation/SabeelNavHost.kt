package com.kitalonlabs.sabeel.ui.navigation
...
import com.kitalonlabs.sabeel.ui.dhikr.DhikrLibraryScreen
import com.kitalonlabs.sabeel.ui.home.HomeScreen
import com.kitalonlabs.sabeel.ui.settings.SettingsScreen
import com.kitalonlabs.sabeel.ui.settings.SettingsViewModel
import com.kitalonlabs.sabeel.ui.tasbih.SessionOrigin
import com.kitalonlabs.sabeel.ui.tasbih.TasbihIntent
import com.kitalonlabs.sabeel.ui.tasbih.TasbihScreen
import com.kitalonlabs.sabeel.ui.tasbih.TasbihViewModel
import com.kitalonlabs.sabeel.ui.theme.SabeelColors
import com.kitalonlabs.sabeel.ui.wird.WirdEditScreen
import com.kitalonlabs.sabeel.ui.wird.WirdScreen
import com.kitalonlabs.sabeel.ui.wird.WirdViewModel
        ...
        NavHost(
            ...
            navigation(startDestination = SabeelTab.Home.startRoute, route = SabeelTab.Home.graphRoute) {
                composable(SabeelTab.Home.startRoute) {
                    ...
                    HomeScreen(
                        ...
                        onTooltipDismiss = {
                            settingsViewModel.processIntent(com.kitalonlabs.sabeel.ui.settings.SettingsIntent.SetHasSeenHomeTooltip(true))
                        }
                    )
                }
                ...
                composable(
                    ...
                    WirdScreen(
                        ...
                        onTooltipDismiss = {
                            settingsViewModel.processIntent(com.kitalonlabs.sabeel.ui.settings.SettingsIntent.SetHasSeenWirdTooltip(true))
                        }
                    )
                }
                ...
                composable(
                    ...
                    WirdEditScreen(
                        ...
                        onTooltipDismiss = {
                            settingsViewModel.processIntent(com.kitalonlabs.sabeel.ui.settings.SettingsIntent.SetHasSeenWirdPickerTooltip(true))
                        }
                    )
                }
            }
            ...
            navigation(startDestination = SabeelTab.Count.startRoute + "?dhikrKey={dhikrKey}&target={target}", route = SabeelTab.Count.graphRoute) {
                composable(
                    ...
                    val homeViewModel: com.kitalonlabs.sabeel.ui.home.HomeViewModel = hiltViewModel()
                    ...
                    TasbihScreen(
                        ...
                        onTooltipDismiss = {
                            settingsViewModel.processIntent(com.kitalonlabs.sabeel.ui.settings.SettingsIntent.SetHasSeenTasbihTooltip(true))
                        }
                    )
                }
            }
            ...
            navigation(startDestination = SabeelTab.Dhikr.startRoute, route = SabeelTab.Dhikr.graphRoute) {
                composable(SabeelTab.Dhikr.startRoute) {
                    DhikrLibraryScreen(
                        ...
                        onTooltipDismiss = {
                            settingsViewModel.processIntent(com.kitalonlabs.sabeel.ui.settings.SettingsIntent.SetHasSeenLibraryTooltip(true))
                        }
                    )
                }
                ...
                composable(
                    ...
                    com.kitalonlabs.sabeel.ui.dhikr.AsmaUlHusnaGalleryScreen(
                        language = language,
                        showTransliteration = settingsState.translitEnabled,
                        onBack = { navController.popBackStack() },
                        onCountNow = { key ->
